...
<script>
	function pass(val) {
		...
		document.getElementById('SystemHome').submit();
	}
</script>
			...
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" id="SystemHome" name="SystemHome"
							method="post" action="${pageContext.request.contextPath}/extraction/SystemDetails">
